...
#------------------[ USER-AGENT ]-------------------#
ua = ["Mozilla/5.0 (X11; U; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.5627.196 Safari/537.36:,]
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r {P}[SK 🔥]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
